...
An internet connection is not required once installed. No user data is transmitted. Your data is stored securely on your local device.
...
Your current database will be replaced by the backup, so be certain you want to restore your previous records before proceeding.
